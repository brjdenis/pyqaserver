...
<head>
	...
	<script type="text/javascript">
		...
		function tolerance_table(){
			...
			var table3 = new Tabulator("#table3", {
				columns:[
			        {title:"Id", field:"Id"},
			        {title:"Machine", field:"Machine"},
			        {title:"TOLERANCE_FLAT", field:"TOLERANCE_FLAT"},
			        {title:"TOLERANCE_SYM", field:"TOLERANCE_SYM"},
		...
		function update_settings(){
			var formData = new FormData();
			var tolerance_flat = document.getElementById("tolerance_flat").value;
			var tolerance_sym = document.getElementById("tolerance_sym").value;
			var generate_pdf = document.getElementById("generate_pdf").checked;
			formData.append("tolerance_flat", tolerance_flat);
			formData.append("tolerance_sym", tolerance_sym);
		...
		function add_tolerance(){
			var formData = new FormData();
			var tolerance_flat_tol = document.getElementById("tolerance_flat_tol").value;
			var tolerance_sym_tol = document.getElementById("tolerance_sym_tol").value;
			...
			formData.append("tolerance_flat_tol", tolerance_flat_tol);
			formData.append("tolerance_sym_tol", tolerance_sym_tol);
...
<body>
	<div class="container">
		<div class="panel panel-default">
		  <div class="panel-heading">Flatness/Symmetry machines</div>
		...
		<div class="panel panel-default">
		  <div class="panel-heading">Flatness/Symmetry generic tolerance</div>
		  	<div class="panel-body">
				<div class="row">
					 <div class="col-xs-12 col-md-6">
						<div id="table2">
					...
					<div class="col-xs-12 col-md-6">
						<div class="form-group">
							...
							<div class="input-group">
								<span class="input-group-addon" id="sizing-addon" style="width:50%" >Tolerance flatness:</span>
								<input type="text" class="form-control" id="tolerance_flat" autocomplete="off" onkeyup="this.value=this.value.replace(/,/,'.')">
							</div>
							<div class="input-group">
								<span class="input-group-addon" id="sizing-addon" style="width:50%" >Tolerance symmetry:</span>
								<input type="text" class="form-control" id="tolerance_sym" autocomplete="off" onkeyup="this.value=this.value.replace(/,/,'.')">
							</div>
		...
		<div class="panel panel-default">
		  <div class="panel-heading">Flatness/Symmetry machine tolerance</div>
		  	<div class="panel-body">
				<div class="row">
					...
					<div class="col-xs-12 col-md-4">
						<div class="form-group">
							...
							<div class="input-group">
								<span class="input-group-addon" id="sizing-addon" style="width:50%" >Tolerance flatness:</span>
								<input type="text" class="form-control" id="tolerance_flat_tol" autocomplete="off" onkeyup="this.value=this.value.replace(/,/,'.')">
							</div>
							<div class="input-group">
								<span class="input-group-addon" id="sizing-addon" style="width:50%" >Tolerance symmetry:</span>
								<input type="text" class="form-control" id="tolerance_sym_tol" autocomplete="off" onkeyup="this.value=this.value.replace(/,/,'.')">
							</div>
