	...
	<script type="text/javascript">
		...
		function treatmentunits_table(){
			var table = new Tabulator("#table", {
			    ...
			    ajaxURL:"{{plweb_folder}}/get_treatmentunits_fieldrotation", //ajax URL
		...
		function settings_table(){
			...
			var table2 = new Tabulator("#table2", {
			    ...
			    ajaxURL:"{{plweb_folder}}/get_settings_fieldrotation", //ajax URL
			    ajaxParams:{}, //ajax parameters
			    ajaxConfig:"post", //ajax HTTP request type
			});
		...
		function tolerance_table(){
			...
			var table3 = new Tabulator("#table3", {
			    ...
			    layout:"fitData", //fit columns to width of table (optional)
			    ajaxURL:"{{plweb_folder}}/get_tolerance_fieldrotation", //ajax URL
			    ajaxParams:{}, //ajax parameters
			    ajaxConfig:"post", //ajax HTTP request type
			});
			//table.setData("{{plweb_folder}}/get_user_data", {}, "post");
		...
		function add_treatmentunit(){
			...
			if (window.XMLHttpRequest) {
				...
				xmlhttp.open("POST", "{{plweb_folder}}/add_treatmentunit_fieldrotation", true);
		...
		function remove_treatmentunit(){
			...
			if (window.XMLHttpRequest) {
				...
				xmlhttp.open("POST", "{{plweb_folder}}/remove_treatmentunit_fieldrotation", true);
				xmlhttp.send(formData);
		}
		...
		function update_settings(){
			...
			if (window.XMLHttpRequest) {
				...
				xmlhttp.open("POST", "{{plweb_folder}}/update_settings_fieldrotation", true);
				xmlhttp.send(formData);
		}
		...
		function add_tolerance(){
			...
			if (window.XMLHttpRequest) {
				...
				xmlhttp.open("POST", "{{plweb_folder}}/add_tolerance_fieldrotation", true);
				xmlhttp.send(formData);
		}
		...
		function remove_tolerance(){
			...
			if (window.XMLHttpRequest) {
				...
				xmlhttp.open("POST", "{{plweb_folder}}/remove_tolerance_fieldrotation", true);
				xmlhttp.send(formData);
		}
