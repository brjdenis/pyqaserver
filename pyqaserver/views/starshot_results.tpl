...
<body>
    <ul class="nav nav-tabs nav-justified">
        ...
        <li>
            <a data-toggle="pill" id="bs-tab2" href="#menu21">
                Save result
            </a>
        </li>
      </ul>
      ...
      <div class="tab-content">
        <div id="menu1" class="tab-pane fade in active">
            ...
            <table class="table">
                <tr>
                    <td>Tolerance </td><td>{{tolerance}} mm</td>
                </tr>
                <tr>
                    <td>Radius</td><td>{{round(radius, 3)}} mm</td>
                </tr>
                <tr>
                    <td>Diameter</td><td>{{round(2*radius, 3)}} mm</td>
                </tr>
                <tr>
                    <td>Circle center</td><td>{{round(circle_center.x, 2)}} px,  {{round(circle_center.y, 2)}} px</td>
                </tr>
                <tr>
                    <td>Status</td>
                    <td>
